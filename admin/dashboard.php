		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					...
					<div st1yle=" text-align: right;margin-bottom:30px; " class="frmSearch">
						<input type="text" id="search-box" name="keyword" placeholder="Search..." />
						<div id="suggesstion-box" style=" z-index: 2000; position: absolute; "></div>
