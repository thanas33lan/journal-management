		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h3 class="page-title">Edit Author : <?php echo ucwords(htmlentities($result->name)); ?></h3>
							<div class="row">
								<div class="col-md-12">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<select name="gender" class="form-control" required>
															...
															<option value="Male" <?php echo (isset($result->gender) && $result->gender == 'Male')?"selected='selected'":"";?>>Male</option>
															<option value="Female" <?php echo (isset($result->gender) && $result->gender == 'Female')?"selected='selected'":"";?>>Female</option>
														</select>
													</div>
